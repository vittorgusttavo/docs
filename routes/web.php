...
Route::middleware('auth')->group(function () {
    ...
    // Audit Log
    Route::get('/settings/audit', [ActivityControllers\AuditLogCustomController::class, 'index']);

    // Users
    Route::get('/settings/users', [UserControllers\UserCustomController::class, 'index']);
    Route::get('/settings/users/create', [UserControllers\UserCustomController::class, 'create']);
    Route::get('/settings/users/{id}/delete', [UserControllers\UserCustomController::class, 'delete']);
    Route::post('/settings/users/create', [UserControllers\UserCustomController::class, 'store']);
    Route::get('/settings/users/{id}', [UserControllers\UserCustomController::class, 'edit']);
    Route::put('/settings/users/{id}', [UserControllers\UserCustomController::class, 'update']);
    Route::delete('/settings/users/{id}', [UserControllers\UserCustomController::class, 'destroy']);
...
Route::get('/register', [AccessControllers\RegisterCustomController::class, 'getRegister']);
Route::get('/login', [AccessControllers\LoginCustomController::class, 'getLogin']);
Route::post('/login', [AccessControllers\LoginCustomController::class, 'login']);
Route::post('/logout', [AccessControllers\LoginCustomController::class, 'logout']);
...
Route::post('/register', [AccessControllers\RegisterCustomController::class, 'postRegister'])->middleware('throttle:public');
