...
@section('content')
    <div class="container very-small">
        ...
        <div class="card content-wrap auto-height">
            <h1 style="text-align: center" class="list-heading">{{ Str::title(trans('auth.sign_up')) }}</h1>
            ...
            <form action="{{ url("/register") }}" method="POST" class="mt-l stretch-inputs">
                ...
                <div class="form-group">
                    <label for="id_client">{{ trans('auth.id_client') }}</label>
                    @include('form.text', ['name' => 'id_client'])
                </div>
                 <div class="form-group">
                    @include('custom.term-accept')
                </div>
