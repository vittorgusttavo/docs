...
@section('body')
    <div class="container">
        ...
        <div class="card content-wrap auto-height">
            ...
            <div class="item-list" style="min-width: auto; width: 100%;">
                <div class="item-list-row flex-container-row items-center bold hide-under-m">
                    ...
                    <div class="flex-2 px-m py-xs">{{ trans('settings-custom.observation') }}</div>
                </div>
                @foreach($activities as $activity)
                    <div class="item-list-row flex-container-row items-center wrap py-xxs">
                        ...
                        <div class="flex-2 flex-container-row px-m py-xxs break-text"><strong
                                    class="mr-xs hide-over-m">{{ trans('settings-custom.observation') }}
                                :</strong> {{ $activity->observation }}</div>
                    </div>
                @endforeach
            </div>
            </div>
